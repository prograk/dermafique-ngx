...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(_appService, _formBuilder) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function prepareLogin() {
          ...
          this.auth2.attachClickHandler(this.loginRef.nativeElement, {}, function (googleUser) {
            ...
            _this4.LoginName = profile.getName();
            _this4.LoginEmail = profile.getEmail();

            _this4.SignIn(); //console.log('Image URL: ' + profile.getImageUrl());
        ...
        value: function ngOnInit() {
          ...
          this._appService.GetSkinTypes().subscribe(function (data) {
            return _this5.GetSkinTypes = data;
          });
          ...
          ngx_webcam__WEBPACK_IMPORTED_MODULE_3__["WebcamUtil"].getAvailableVideoInputs().then(function (mediaDevices) {
            _this5.multipleWebcamsAvailable = mediaDevices && mediaDevices.length > 1;
          });
        }
      }, {
        key: "triggerSnapshot",
        ...
        */
        ...
        value: function callApi() {
          ...
          this._appService.checkSkin(this.imgFile).subscribe(function (res) {
            _this7.code = 'SUCCESSFUL';
            _this7.dataaa = res;
            console.log(_this7.dataaa);
            console.log(res);
            _this7.apiId = _this7.dataaa['id'];
            _this7.message = JSON.stringify(res);
            _this7.slide6Show = false;
            _this7.slideLogin = true;
          }, function (err) {
            console.log(err.error.error.message);
            _this7.code = err.error.error.code;
            _this7.message = err.error.error.message;
  ...
  function srcAppAppServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppService = /*#__PURE__*/function () {
      ...
      _createClass(AppService, [{
        key: "checkSkin",
        value: function checkSkin(image) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/akshamalhotra/Development/more/naveed/dermafique-skin-tool/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
