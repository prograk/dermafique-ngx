...
export class AppComponent implements OnInit {
  ...
  */
  ...
  public dataaa:any = {
    ...
    "outputImages": {
        "strength_image": "https://skincaredemo.orbo.ai/api/media/skincareresult/download/5d9aacf6-a2c7-4954-bcac-c76a8fe839c9sm-strength.jpg"
    },
    "priorityInfo": {
        "topPriorities": [
            {
