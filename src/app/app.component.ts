...
export class AppComponent implements OnInit {
  ...
  */
  ...
  // public dataaa:any;
  public dataaa = {
    "id":"61cae0fb57330f00397aa4d2",
    "outputData":{
       "dark_spot_percentage":6,
       "uneven_skin_percentage":62,
       "skin_dullness_percentage":11,
       "face_wrinkle_percentage":7,
       "face_firmness_percentage":93,
       "Smoothness":68,
       "hydration_score":80,
    ...
    "outputImages":{
       "strength_image":"https://skincaredemo.orbo.ai/api/media/skincareresult/download/765a6465-ef24-4064-9368-63d10188c908sm-strength.jpg"
    },
    "priorityInfo":{
       "topPriorities":[
          {
             ...
             "priority_product_info":{
                ...
                "concerns":{
                   ...
                   "causes":{
                      ...
                      "points":[
                         "It occurs due to increased melanin synthesis caused by prolonged exposure to sun rays.",
                         "Due to a compromised skin barrier caused by lack of hydration. ",
                         "As you are under 30, hyperpigmentation caused by acne can also be a factor for oily, acne-prone skin."
                      ]
                   },
                   "needs":{
             ...
             "priority_product_info":{
                ...
                "concerns":{
                   ...
                   "causes":{
                      ...
                      "points":[
                         "Oily skin should not be mistaken to be adequately hydrated because of its appearance. In fact, when skin lacks water content, it overproduces oil to compensate for the lack of moisture. ",
                ...
                "solution":{
                   "solution_recommends":"Dermafique Smart Skin Advisor Recommends: The Dermafique Hydra Tonique Gel Crème, a lightweight daily cream to take care of your skin concern of lack of hydration. A deeply hydrating cream, it prevents transepirdermal water loss, boosts moisture to nourish skin and maintains the skin barrier function.",
                   "solution_recommends_desc":null,
                   "points":[
                      {
             ...
             "priority_product_info":{
                ...
                "concerns":{
                   ...
                   "causes":{
                      ...
                      "points":[
                         "Lack of firmness occurs due to loss of collagen and elastin as well as moisture loss."
                      ]
                   },
                   "needs":{
                      "image":"https://www.dermafique.com/smartskinadvisor/icons/firm-healthy-skin.png",
                      "points":[
                         "To improve the firmness of your skin, you need a skincare solution that contains antioxidants that prevent collagen breakdown and repair skin damage.",
                         "It also needs to boost essential ceramides (skin's natural oils) to fortify your skin."
                      ]
                   }
                },
                "solution":{
                   ...
                   "points":[
                      {
                         "image":"https://www.dermafique.com/smartskinadvisor/icons/anti-oxidant.png",
                         "point":"Powered with 'Dermarefine Complex' that replenishes antioxidants."
                      },
                      {
                         "image":"https://www.dermafique.com/smartskinadvisor/icons/prevents-collagen-breakdown.png",
                         "point":"Boosts Ceramide Synthesis and prevents collagen breakdown through Niacinamide action on skin cells."
                      },
                      {
                         "image":"https://www.dermafique.com/smartskinadvisor/icons/niacinamide-and-shea-butter.png",
                         "point":"Enriched with Pro Vitamin E, Niacinamide and Shea Butter, along with other actives that help in skin hydration and regeneration."
                      }
                   ],
                   "solution_concluding_paragraph":"It also makes the skin feel more hydrated and supple."
                },
                "expert":{
          ...
          },
          {
             ...
             "priority_product_info":{
                ...
                "solution":{
                   "solution_recommends":"Dermafique Smart Skin Advisor Recommends:The Dermafique Soleil Defense Gel Crème SPF 30, a lightweight sunscreen that will help address your skin concern of dark spots. Powered with Full Light Technology, it targets not just UV rays, but 360° Sun Spectrum including Infrared Rays and Visible Light. It also helps protects from tanning, photo-ageing and persistent pigmentation. ",
  ...
  public activeResultTab = 'Uneven Skin Tone';
