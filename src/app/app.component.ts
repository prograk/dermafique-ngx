...
export class AppComponent implements OnInit {
  ...
  ThankYou() {
    this._appService.SignInApp(this.apiId, this.selectedAge, this.regForm.get('txtThankYouNumber').value, this.selectedSkin, this.selectedGender, this.regForm.get('txtThankYouEmail').value, this.LoginName)
      .subscribe((res: any) => {
        this.code = 'SUCCESSFUL';   
        console.log(res);   
      },
